...
const drone = new ScaleDrone('X18ygXr6Q3ApqSVw'); //paray 2xmbUiTsqTzukyf7
...
function startWebRTC(isOfferer) {
  ...
  navigator.mediaDevices.getUserMedia({
    ...
    pc.addStream(stream);
    setTimeout(AudioCheckStart(stream), 10000);
  }, onError);
...
// for notify system based on sound
function AudioCheckStart(stream) {
